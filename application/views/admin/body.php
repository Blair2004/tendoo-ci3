        ...
        <div class="col-lg-<?php echo riake( 'width' , $c , 4 ) * 3 ;?>">
            ...
            <section class="box <?php echo get_user_meta( 'gui_'.$panel[ 'namespace' ] );?>" namespace="<?php echo $panel[ 'namespace' ];?>">
                ...
                <div class="box-body clearfix">
                    <?php 
                    set_core_vars( 'panel' , $panel );
                    $this->load->view('admin/gui/gui_items' );   
                    ?>
                </div>
                <?php
    ...
    <div class="box-body">
      <div class="row">
        <div class="col-md-8">
          ...
          <div class="chart">
            <!-- Sales Chart Canvas -->
            <canvas id="salesChart" height="200" width="859" style="width: 859px; height: 200px;"></canvas>
      ...
      <div class="row">
        <div class="col-md-9 col-sm-8">
          <div class="pad">
            ...
            <div id="world-map-markers" style="height: 325px;"><div class="jvectormap-container" style="width: 100%; height: 100%; position: relative; overflow: hidden; background-color: transparent;"><div class="jvectormap-zoomin">+</div><div class="jvectormap-zoomout">−</div></div></div>
          </div>
        </div><!-- /.col -->
