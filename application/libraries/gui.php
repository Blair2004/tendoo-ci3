...
class GUI
{
	...
	function __construct()
	{
		...
		$this->enqueue	=	get_instance()->enqueue;
	...
	*/
	...
	public function get()
	{
		set_core_vars( 'page-header' , $this->load->view( 'admin/gui/page-header' , array() , true ) );
		
		$this->load->view( 'admin/header' );		
		$this->load->view( 'admin/horizontal-menu' );		
		$this->load->view( 'admin/aside' );		
		$this->load->view( 'admin/body' );
		$this->load->view( 'admin/footer' );	
		$this->load->view( 'admin/aside-right' );
	}
	// INSTANT USE
